...
static vector<vector<int>> input = {{5,1,9,5},{7,5,3},{2,4,6,8}};

static vector< vector<int>> input = {{3093 , 749  , 3469 , 142  , 2049 , 3537 , 1596 , 3035 , 2424 , 3982 , 3290 , 125  , 249  , 131  , 118  , 3138},
...
int main(int argc, char *argv[])
{
  ...
  {
    int lvSmallest = input[i][0];
    int lvBiggest = input[i][0];

    for(int j = 1; j < input[i].size(); j++)
    {
      if(input[i][j] < lvSmallest)
        lvSmallest = input[i][j];

      if(input[i][j] > lvBiggest)
        lvBiggest = input[i][j];
    }

    lvChecksum += abs(lvBiggest - lvSmallest);
  }

  cout << "Checksum is " << lvChecksum << endl;
